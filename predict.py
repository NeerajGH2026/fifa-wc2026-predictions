import os, smtplib, pickle, pandas as pd
...
# ============================================================
# ✏️ EDIT THESE TWO SECTIONS EVERY MORNING (then push to GitHub)
# ============================================================
...
# ============================================================
# FEATURE ENGINEERING (mirrors your Colab cells)
# ============================================================
def compute_team_stats(df, team, before_date=None):
    if before_date:
...
# Add yesterday's results with high weight
